...
public class WebLogDetailServiceImpl extends AbstractBatchInsertService<WebLogDetailDTO> implements WebLogDetailService {
    ...
    @Override
    public List<WebLogIndex> dateLogIndex(String deviceId, long logDate) {
        try {
            return detailMapper.dateLogIndex(deviceId,logDate);
        } catch (Exception e) {
            LOGGER.error(e);
            return Collections.emptyList();
        }
    ...
    @Override
    public List<WebLogDetailDTO> dateLogDetails(String deviceId, long logDate) {
        try {
            return detailMapper.dateLogDetails(deviceId,logDate);
        } catch (Exception e) {
            LOGGER.error(e);
            return Collections.emptyList();
        }
