...
import { getDbInstance } from './dbMap';
/**
 * @returns Promise<number> with reported pageIndex if this page has logs, otherwise Promise<null>.
 */
function getLogAndSend(reportName, reportConfig, config) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var LoganDBInstance, logItems, pageIndex_1, logItemStrings, logReportOb, customXHROpts_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    LoganDBInstance = getDbInstance(config);
                    return [4 /*yield*/, LoganDBInstance.getLogsByReportName(reportName)];
                case 1:
                    logItems = _b.sent();
                    ...
                    return [4 /*yield*/, Ajax(customXHROpts_1.reportUrl || reportConfig.reportUrl || config.get('reportUrl'), customXHROpts_1.data || JSON.stringify({
                            ...
                            appName: reportConfig.appName,
                            objType: reportConfig.objType,
                            ...
                            logArray: logItems
                                ...
                                .toString()
                        }), (_a = customXHROpts_1.withCredentials) !== null && _a !== void 0 ? _a : true, 'POST', customXHROpts_1.headers || {
...
export default function reportLog(reportConfig, config) {
    return __awaiter(this, void 0, void 0, function () {
        var LoganDBInstance;
        var _this = this;
                                ...
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, Promise.all(logReportMap[logDay].map(function (reportName) {
                                                return getLogAndSend(reportName, reportConfig, config);
                                            }))];
                                    case 4:
