...
export default function saveLog(logConfig, config, logManager) {
    return __awaiter(this, void 0, void 0, function () {
        var LoganDBInstance_1, logStringOb_1, publicKey, cipherOb, logStringOb_2, e_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    LoganDBInstance_1 = getDbInstance(config);
                    ...
                    return [4 /*yield*/, invokeInQueue(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, LoganDBInstance_1.addLog(JSON.stringify(logStringOb_1))];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
                ...
                case 2:
                    ...
                    return [4 /*yield*/, invokeInQueue(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, LoganDBInstance_1.addLog(JSON.stringify(logStringOb_2))];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
