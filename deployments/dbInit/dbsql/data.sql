...
return tempCall(${message});', 'select concat(round(sum(data_length/1024/1024),2)) as data from information_schema.TABLES where table_schema=''logfv'' and (table_name = ''web_task''
...
INSERT INTO interface_release (pub_id, pub_api_id, pub_method, pub_path, pub_status, pub_type, pub_script, pub_script_ori, pub_schema, pub_sample, pub_option, pub_release_time, pub_comment) VALUES ('r_em267mghd-nka', 'i_ejf0k4m547nb5', 'GET', '/api/logfv/web/queryTotalPage', '1', 'DataQL', 'hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
var dataSet = @@sql()<%
select count(*) from web_detail;
%>
return dataSet(); ', 'hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
...
INSERT INTO interface_release (pub_id, pub_api_id, pub_method, pub_path, pub_status, pub_type, pub_script, pub_script_ori, pub_schema, pub_sample, pub_option, pub_release_time, pub_comment) VALUES ('r_em284g0em30im', 'i_eje29j14a-ag8', 'GET', '/api/logfv/web/queryLogCount', '1', 'DataQL', 'hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
hint FRAGMENT_SQL_OPEN_PACKAGE = "off"
var dataSet = @@sql()<%
select * from (
select b.device_id,b.device_name,count(a.id) as log_count from web_detail a
...
INSERT INTO interface_release (pub_id, pub_api_id, pub_method, pub_path, pub_status, pub_type, pub_script, pub_script_ori, pub_schema, pub_sample, pub_option, pub_release_time, pub_comment) VALUES ('r_em28907j4848f', 'i_eje2kj4bljclm', 'GET', '/api/logfv/web/queryTaskByDate', '1', 'DataQL', 'hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
hint FRAGMENT_SQL_OPEN_PACKAGE = "off"
hint FRAGMENT_SQL_QUERY_BY_PAGE = true
hint FRAGMENT_SQL_QUERY_BY_PAGE_NUMBER_OFFSET = 1
...
INSERT INTO interface_release (pub_id, pub_api_id, pub_method, pub_path, pub_status, pub_type, pub_script, pub_script_ori, pub_schema, pub_sample, pub_option, pub_release_time, pub_comment) VALUES ('r_em28alig4-94a', 'i_eje31jj424035', 'GET', '/api/logfv/web/query', '1', 'DataQL', '// a new Query.
// SQL 执行器切换为分页模式
hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
hint FRAGMENT_SQL_QUERY_BY_PAGE = true
hint FRAGMENT_SQL_OPEN_PACKAGE = "off"
...
INSERT INTO interface_info (api_id, api_method, api_path, api_status, api_comment, api_type, api_script, api_schema, api_sample, api_option, api_create_time, api_gmt_time, api_name) VALUES ('i_em2jh8dle-abh', 'GET', '/api/logfv/web/getDayLogType', '1', '获取某天的日志类型汇总数据', 'DataQL', '// a new Query.
hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
hint FRAGMENT_SQL_OPEN_PACKAGE = "off"
...
INSERT INTO interface_release (pub_id, pub_api_id, pub_method, pub_path, pub_status, pub_type, pub_script, pub_script_ori, pub_schema, pub_sample, pub_option, pub_release_time, pub_comment) VALUES ('r_em2jj1h95-94k', 'i_em2jh8dle-abh', 'GET', '/api/logfv/web/getDayLogType', '1', 'DataQL', '// a new Query.
hint FRAGMENT_SQL_DATA_SOURCE = "logfv"
hint FRAGMENT_SQL_OPEN_PACKAGE = "off"
