...
&& cp -rf /home/dpark-dataway ./dpark-dataway
# 修改配置
...
sed -i 's@DB_HOST@'$DB_HOST'@g;s@DB_PORT@'$DB_PORT'@g;s@DB_NAME@'$DB_NAME'@g;s@DB_USER@'$DB_USER'@g;s@DB_PASSWD@'$DB_PASSWD'@g' ./dpark-dataway/config/application-prod.yml
...
cd ../dpark-dataway && mkdir logs && ./application.sh start \
