...
# 拷贝项目
rm -rf ./* \
&& cp -rf /home/logdog ./$URL_PATH \
&& cp -rf /home/logdog-server ./$URL_PATH-server \
&& cp -rf /home/logdog-server.war ./$URL_PATH-server.war \
...
sed -i 's@BASE_API@'$BASE_API'@g' ./$URL_PATH/biz/logdogSite/js/project.*
